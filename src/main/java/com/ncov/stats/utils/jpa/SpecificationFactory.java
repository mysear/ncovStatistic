...
public final  class SpecificationFactory {
    ...
    public static Specification notEqual(String attribute, String value){
    ...
    public static Specification greater(String attribute, Date value) {
     ...
     * @return
     * */
     public static Specification less(String attribute, Integer value) {
        return (root, query, cb) -> cb.lessThan(root.get(attribute),value);
    }
     public static Specification less(String attribute, int value) {
         return (root, query, cb) -> cb.lessThan(root.get(attribute),value);
     }
    public static Specification less(String attribute, Long value) {
        return (root, query, cb) -> cb.lessThan(root.get(attribute),value);
    }
    public static Specification less(String attribute, long value) {
        return (root, query, cb) -> cb.lessThan(root.get(attribute),value);
    }
    public static Specification less(String attribute, double value) {
        return (root, query, cb) -> cb.lessThan(root.get(attribute),value);
    }
    public static Specification less(String attribute, Date value) {
        return (root, query, cb) -> cb.lessThan(root.get(attribute),value);
    }
